...
const assets: PortfolioAsset[] = [
  ...
  },
  {
    ...
    caption:
      "Desarrollo de identidad visual y materiales editoriales para una propuesta gastronómica enfocada en hospitalidad y banquetes. El proyecto incluyó investigación, estrategia de comunicación visual, fotografía gastronómica, aplicaciones impresas y diseño de piezas promocionales utilizando elementos existentes de marca para construir una experiencia visual más coherente y atractiva.",
    cardSummary: "Identidad visual y materiales editoriales para una propuesta gastronómica.",
    src: assetPath("real-banquetes-editorial-branding.png"),
    alt: "Real Banquetes editorial branding and print materials",
    format: "IDENTIDAD VISUAL & MATERIALES EDITORIALES",
    gridLabel: "BRANDING · EDITORIAL · PRINT",
    objective: "Crear una línea visual editorial orientada a transmitir calidez, tradición y experiencia gastronómica a través de materiales impresos y promocionales.",
    role: "Investigación visual · Estrategia de comunicación · Dirección visual · Fotografía · Diseño editorial · Aplicaciones impresas · Material promocional",
